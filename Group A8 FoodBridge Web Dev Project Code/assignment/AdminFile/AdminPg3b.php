...
<form name="fSearch" id="fSearch" action="AdminPg3b.php" method="POST">
...
if($key=="")
   ...
   $sql="select * FROM fooddonation WHERE firstName LIKE '%$key%' 
   OR lastName LIKE '%$key%' 
   OR email LIKE '%$key%' 
   OR pick_up_location LIKE '%$key%'
   OR state LIKE '%$key%'
...
?>
   ...
   Pick Up Location: <?php echo $row["pick_up_location"]?><br>
   State: <?php echo $row["state"]?><br>
   Food Description: <?php echo $row["foodDescription"]?><br>
   Category: <?php echo $row["category"]?><br>
   Total Weight: <?php echo $row["totalWeight"]?><br>
   Collection Time: <?php echo $row["collectionTime"]?><br>
   Collection Date: <?php echo $row["collectionDate"]?><br>
   Food Bank Location: <?php echo $row["foodBankLocation"]?><br>
   Action: <a href="AdminPg3c.php?id=<?php echo $row["id"]?>">edit</a> 
   <a href="AdminPg3e.php?id=<?php echo $row["id"]?>">delete</a> <br>
   </p>
...
<h3> <a href="AdminPg3.php">Add</a></h3>
</div>
